	...
	public static void main(String[] args) {
		...
		switch(op)
		{
			...
			case 3: 
				...
				ct.setCustomerId(7);
				ct.setBillAmount(3434);
				ct.setCustomerAddress("pune");
				ct.setCustomerName("noname");
			...
			case 4:
				...
				break;
			case 5:
				System.out.println(customerDAO.searchCustomerById(300));
				break;
			case 6:  
				System.out.println(customerDAO.deleteCustomer(102));
				break;
